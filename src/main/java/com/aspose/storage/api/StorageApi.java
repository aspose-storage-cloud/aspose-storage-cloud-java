...
public class StorageApi {
    ...
    public File GetDownload(String path, String versionId, String storage) {
        Object postBody = null;
        // verify required params are set
        if (path == null) {
            throw new ApiException(400, "missing required params");
        ...
        // create path and map variables
        String resourcePath = "/storage/file/?path={path}&amp;appSid={appSid}&amp;versionId={versionId}&amp;storage={storage}";
        resourcePath = resourcePath.replaceAll("\\*", "").replace("&amp;", "&").replace("/?", "?").replace("toFormat={toFormat}", "format={format}");
        // query params
        Map<String, String> queryParams = new HashMap<String, String>();
        Map<String, String> headerParams = new HashMap<String, String>();
        ...
        try {
            response = apiInvoker.invokeAPI(basePath, resourcePath, "GET", queryParams, postBody, headerParams, formParams, contentType);
            return (File) ApiInvoker.deserialize(response, path, File.class);
        } catch (ApiException ex) {
            if (ex.getCode() == 404) {
                throw new ApiException(404, "");
            } else {
    ...
    public ResponseMessage PutCopy(String Path, String newdest, String versionId, String storage, String destStorage) {
        Object postBody = null;
        // verify required params are set
    ...
    public FilesResponse GetListFiles(String Path, String storage) {
        Object postBody = null;
        // create path and map variables
